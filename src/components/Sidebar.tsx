...
import { FaHome, FaCode, FaBook, FaCog, FaCreditCard, FaUserCircle, FaExternalLinkAlt, FaListUl, FaGlobe } from 'react-icons/fa';
    ...
    <aside className="h-screen w-64 bg-white border-r flex flex-col justify-between fixed left-0 top-0 z-40 shadow-sm">
      <div>
        ...
        <div className="flex items-center gap-2 px-6 py-6">
          <img src="/logo.svg" alt="Tavily Logo" className="h-8 w-8" />
          <span className="font-bold text-xl text-gray-800">tavily</span>
        </div>
